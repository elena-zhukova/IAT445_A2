 ...
 * 
 * Step 4: Select the Cube and in the inspector under ChangeScene(Script) component put the name of the scene you added in Step 3 (e.g., "Desert"). 
 *
 * Step 5 (optional): you can make the Cube invisible by disabling the Mesh Renderer in the inspector
 * 
 * Voila!
*/
